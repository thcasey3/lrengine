...
class scikit:
    ...
    def __init__(
        ...
        if X_columns is not None or y_column is not None:
            ...
            X_train, X_test, y_train, y_test = train_test_split(
                ...
                lsdata.scikit_object["y"],
                test_size=scikit_params["test_size"],
                random_state=42,
            )
    ...
    def _Xy_split(self, lsdata, X_columns=None, y_column=None):
        ...
        if X_columns is not None and y_column is not None:
            lsdata.scikit_object["X"] = lsdata.sciframe[X_columns]
            lsdata.scikit_object["y"] = lsdata.sciframe[y_column]
        elif X_columns is None and y_column is not None:
            lsdata.scikit_object["X"] = lsdata.sciframe[
                lsdata.sciframe.columns.values - y_column
            ]
            lsdata.scikit_object["y"] = lsdata.sciframe[y_column]
        elif X_columns is not None and y_column is None:
            lsdata.scikit_object["X"] = lsdata.sciframe[X_columns]
            lsdata.scikit_object["y"] = lsdata.sciframe[
